...
export default function OfferEdit() {
  ...
  useEffect(() => {
    const load = async () => {
      if (!id) return;
      try {
        // In a real app we'd fetch the offer by ID here
        // For now just loading schools to allow the form to render properly
        // and assuming we can "edit" by creating a new one or just simulating
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Card>
        <CardHeader><CardTitle>Edit Offer</CardTitle></CardHeader>
        <CardContent>
          <Form {...form}>
